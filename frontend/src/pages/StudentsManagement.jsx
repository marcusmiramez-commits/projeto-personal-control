...
const StudentsManagement = ({ user, onLogout }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.detail || 'Erro ao cadastrar aluno');
    }
  };
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 space-y-4 md:space-y-0">
          <div>
            <h1 className="text-4xl font-bold" style={{ fontFamily: 'Space Grotesk' }}>
              Gerenciar <span className="bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">Alunos</span>
            </h1>
            <p className="text-slate-600 mt-2">Total de alunos: {students.length}</p>
          </div>

          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700" data-testid="add-student-button">
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4" data-testid="student-form">
                ...
                <Button type="submit" className="w-full bg-gradient-to-r from-emerald-500 to-green-600" data-testid="submit-student-button">
                  Cadastrar Aluno
                </Button>
              </form>
            </DialogContent>
              ...
              <div className="space-y-2">
                ...
                {student.monthly_value && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold">R$ {student.monthly_value.toFixed(2)}</span>
                  </div>
                )}
                {student.goal && (
                  <div className="mt-3 pt-3 border-t border-slate-200">
                    <p className="text-xs text-slate-600 mb-1">Objetivo:</p>
